---
layout: post
title: "Ground effect: when nature wants you to fly"
date: 2025-05-10
...
So, ground effect is something for me that is quite not intuitive. Here’s the deal: when people invented planes, they added wings so they could fly. This itself is counter-intuitive for Nature, at least for us. They fought so hard trying to lift something into the sky just to discover when they wanted to land planes, that they “would not” want to come back to the ground. 
...
This effect can be really annoying and even dangerous for some planes and pilots if they aren’t trained. Imagine trying to land your plane on a track: you reduce proportionally your speed so you go down proportionally and at the moment you think you’re gonna touch the ground, you  lift even though your speed has decreased. I also believe that some F1 formula cars are using this effect but the other way around and it should not be mixed up. While a plane’s ground effect is lifting the vehicle, an F1 formula car ground effect is gluing it to the track. 
...
-https://www.youtube.com/watch?v=XS_n9q9Lzwk

-https://www.reddit.com/r/AerospaceEngineering/comments/149yvhg/what_exactly_is_ground_effect_in_f1_and_aircraft/?rdt=50300
