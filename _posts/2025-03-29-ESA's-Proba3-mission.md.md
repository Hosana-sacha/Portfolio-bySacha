...
It doesn’t seem like that, but maintaining this precision is extremely challenging… The satellites experience small gravitational perturbations, and over time, they will slowly drift and eventually re-enter Earth's atmosphere (in 4 years). Imagine flying two spacecraft in such tight synchronization (only 150 meters apart)... it’s literally a world first! Thanks to an automated system using cameras, lasers, and radio signals, they can maintain a formation with 1-millimeter precision, minimizing the risk of collision. 
...
On Earth, studying the corona with this level of detail is nearly impossible because of diffraction: a natural effect that scatters light and blurs the view. Proba-3’s design overcomes this limitation by operating outside the atmosphere, offering a clean, stable view of one of the sun’s corona. 
